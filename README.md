...
- [argocd-vault-plugin](https://github.com/IBM/argocd-vault-plugin) - An ArgoCD plugin to retrieve secrets from Vault and inject them into Kubernetes resources
